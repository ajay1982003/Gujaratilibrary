...
<head>
    ...
    <title>Add Book - Gujarati Library</title>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="bhasha" name="bhasha" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="vishay" name="vishay" />
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="excel_iD" name="excel_iD" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="old_sub_id" class="form-label">Old Sub ID</label>
                                    <input type="text" class="form-control" id="old_sub_id" name="old_sub_id" />
                                </div>
                                <div class="col-md-4">
                                    <label for="new_sub_id" class="form-label">New Sub ID</label>
                                    <input type="text" class="form-control" id="new_sub_id" name="new_sub_id" />
                                </div>
                                <div class="col-md-4">
                                    <label for="new_sub_id_2901" class="form-label">New Sub ID (2901)</label>
                                    <input type="text" class="form-control" id="new_sub_id_2901" name="new_sub_id_2901" />
                                </div>
                            </div>
                            ...
                            <h6 class="mb-3">3. Authors & Contributors</h6>
                             <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="granthkar" name="granthkar" />
                                </div>
                                <div class="col-md-6">
                                    <label for="granthkar_0811" class="form-label">Author (0811)</label>
                                    <input type="text" class="form-control" id="granthkar_0811" name="granthkar_0811" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="punah_granthkar" class="form-label">Co-Author (Punah Granthkar)</label>
                                    <input type="text" class="form-control" id="punah_granthkar" name="punah_granthkar" />
                                </div>
                                <div class="col-md-6">
                                    <label for="punah_granthkar_0811" class="form-label">Co-Author (0811)</label>
                                    <input type="text" class="form-control" id="punah_granthkar_0811" name="punah_granthkar_0811" />
                                </div>
                            </div>
                             <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="teekakar" class="form-label">Commentator (Teekakar)</label>
                                    <input type="text" class="form-control" id="teekakar" name="teekakar" />
                                </div>
                                <div class="col-md-6">
                                    <label for="teekakar_0811" class="form-label">Commentator (0811)</label>
                                    <input type="text" class="form-control" id="teekakar_0811" name="teekakar_0811" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="anuvadak" class="form-label">Translator (Anuvadak)</label>
                                    <input type="text" class="form-control" id="anuvadak" name="anuvadak" />
                                </div>
                                <div class="col-md-6">
                                    <label for="anuvadak_0811" class="form-label">Translator (0811)</label>
                                    <input type="text" class="form-control" id="anuvadak_0811" name="anuvadak_0811" />
                                </div>
                            </div>
                             <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="sampadak" class="form-label">Editor (Sampadak)</label>
                                    <input type="text" class="form-control" id="sampadak" name="sampadak" />
                                </div>
                                <div class="col-md-6">
                                    <label for="sampadak_0811" class="form-label">Editor (0811)</label>
                                    <input type="text" class="form-control" id="sampadak_0811" name="sampadak_0811" />
                                </div>
                            </div>
                             <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="punah_sampadak" class="form-label">Co-Editor (Punah Sampadak)</label>
                                    <input type="text" class="form-control" id="punah_sampadak" name="punah_sampadak" />
                                </div>
                                <div class="col-md-6">
                                    <label for="punah_sampadak_0811" class="form-label">Co-Editor (0811)</label>
                                    <input type="text" class="form-control" id="punah_sampadak_0811" name="punah_sampadak_0811" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="prakashak" name="prakashak" />
                                </div>
                                <div class="col-md-6">
                                    <label for="prakashak_0811" class="form-label">Publisher (0811)</label>
                                    <input type="text" class="form-control" id="prakashak_0811" name="prakashak_0811" />
                                </div>
                            </div>
                             <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="purva_prakashak" class="form-label">Previous Publisher</label>
                                    <input type="text" class="form-control" id="purva_prakashak" name="purva_prakashak" />
                                </div>
                                <div class="col-md-6">
                                    <label for="purva_prakashak_0811" class="form-label">Previous Publisher (0811)</label>
                                    <input type="text" class="form-control" id="purva_prakashak_0811" name="purva_prakashak_0811" />
                                </div>
                            </div>
                            ...
                            <h6 class="mb-3">5. Additional Details</h6>
                             ...
                             <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="shelf_detail" name="shelf_detail" />
                                </div>
                                <div class="col-md-6">
